...
class AuditEventType(str, Enum):
    ...
    VERIFICATION_CASE_STATUS_CHANGED = "VERIFICATION_CASE_STATUS_CHANGED"

    VERIFICATION_DOCUMENT_TYPE_CREATED = "VERIFICATION_DOCUMENT_TYPE_CREATED"
    VERIFICATION_DOCUMENT_TYPE_UPDATED = "VERIFICATION_DOCUMENT_TYPE_UPDATED"
